...
class GameTests: XCTestCase {
    ...
    private func testGameCreatesRounds() {
        ...
        let _ = Game(amountOfRounds: 2, player: Player(), roundCreatable: roundProvider, gameResultProvidable: GameResultProvider())
    ...
    private func testPlayerChoiceMadeEndsRound() {
        ...
        let roundProvider = RoundProvider(words: parsedWords, amountOfRounds: 2, roundDuration: 10, scoreProvidable: ScoreProvider())
        let game = Game(amountOfRounds: 2, player: Player(), roundCreatable: roundProvider, gameResultProvidable: GameResultProvider())
